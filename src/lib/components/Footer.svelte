...
<footer class="mt-16 pb-12 pt-8 border-t border-ctp-surface0">
  <div class="container mx-auto max-w-5xl px-4 flex flex-col items-center gap-3 text-center">
    <div class="text-sm font-semibold text-ctp-subtext1">
    ...
    <div class="flex flex-wrap justify-center items-center gap-x-4 gap-y-2 text-xs font-medium text-ctp-overlay1">
      ...
      <div class="flex items-center gap-2">
        <span class="badge bg-ctp-surface0 border-none text-ctp-subtext1 text-[10px] font-semibold tracking-wider">{version}</span>
